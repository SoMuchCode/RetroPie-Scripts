...
# FinalBurn Alpha 2018
# FBA 2.97.43 Roms
# lr-fbalpha.sh
# Put this file in /home/pi/RetroPie-Setup/scriptmodules/libretrocores/
# /home/pi/RetroPie-Setup/scriptmodules/libretrocores/lr-fbalpha.sh
...
rp_module_desc="Arcade emu - FB Alpha (FB Edition) v0.2.97.43 (WIP) port for libretro"
...
function sources_lr-fbalpha() {
    gitPullOrClone "$md_build" https://github.com/barbudreadmon/fbalpha2018.git
}
